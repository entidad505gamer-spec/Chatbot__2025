...
def configurar_pagina():
    ...
    st.set_page_config(page_title="Jarvis el Amigo", page_icon="👾")

    st.title("Jarvis el Amigo")
...
def main():
    ...
    promt_del_usuario = st.chat_input("Escribi tu prompt: ")
